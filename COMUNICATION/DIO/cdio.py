...
# C Prototype: long WINAPI DioInpByteSR(short Id, short PortNo, unsigned char *Data, unsigned short *Timestanp, BYTE Mode);
...
# C Prototype: long WINAPI DioInpBitSR(short Id, short BitNo, unsigned char *Data, unsigned short *Timestanp, BYTE Mode);
...
# C Prototype: long WINAPI DioInpMultiByteSR(short Id, short *PortNo, short PortNum, unsigned char *Data, unsigned short *Timestanp, unsigned char Mode);
...
# C Prototype: long WINAPI DioInpMultiBitSR(short Id, short *BitNo, short BitNum, unsigned char *Data, unsigned short *Timestanp, unsigned char Mode);
